...
public class BoardImgRestController {
    ...
    public ResponseEntity<List<BoardImgDto.BoardImgResultDto>> upload(BoardImgDto.BoardImgUploadDto uploadDto) {
        log.info("uploadFile = {}", uploadDto);
        List<BoardImgDto.BoardImgResultDto> upload = imgService.upload(uploadDto);
